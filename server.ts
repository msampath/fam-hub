...
export const ALLOWED_COPILOT_ACTIONS = new Set(['create_event', 'update_event', 'delete_event', 'add_chore', 'add_shopping_item', 'reserve', 'add_to_cart', 'move_document', 'delete_document', 'delete_chore', 'clear_chores', 'update_chore', 'delete_shopping_item', 'set_goal', 'set_meal_plan', 'delete_meal_plan']);
