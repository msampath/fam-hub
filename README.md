...
- **Chores Tracker** — Per-kid assignment with gamified XP, levels, and weekly banking; picture-first cards (a pure title→emoji map, so pre-readers navigate by icon) and a confetti celebration when a chore's last rep is checked off
