...
- Allowed action types and payload fields:
  ...
  - "add_shopping_item": { text, store (one of the family's OWN store lists — the STORE LISTS line in the request names them; default Costco|Indian Store|Grocery Store|Other) }
